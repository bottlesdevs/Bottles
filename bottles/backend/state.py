...
class TaskStreamUpdateHandler(Protocol):
    def __call__(self, received_size: int = 0, total_size: int = 0, status: Status | None = None) -> None: ...
...
class Task:
    ...
    def stream_update(self, received_size: int = 0, total_size: int = 0, status: Status | None = None):
