...
# - will still install packages if they already exist in org.freedesktop.Sdk
...
system_packages = ['cython', 'easy_install', 'mako', 'markdown', 'meson', 'pip', 'pygments', 'setuptools', 'six',
                   'wheel']
...
for package in packages:
    ...
    if package.name is None:
        print(
            'Warning: skipping invalid requirement specification {} because it is missing a name'.format(package.line),
            file=sys.stderr)
