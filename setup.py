...
install_data = [('share/metainfo', ['data/com.github.mirkobrombin.bottles.appdata.xml']),
                ...
                ('share/icons/hicolor/128x128/apps',['data/notepad.svg']),
                ('share/icons/hicolor/128x128/apps',['data/wine.svg']),
                ('share/icons/hicolor/128x128/apps',['data/winetricks.svg']),
                ('share/icons/hicolor/128x128/apps',['data/wine-uninstaller.svg']),
                ...
                ('bin/bottles/locale/es_ES/LC_MESSAGES',['bottles/locale/es_ES/LC_MESSAGES/bottles.mo']),
                ('bin/bottles/locale/es_ES/LC_MESSAGES',['bottles/locale/es_ES/LC_MESSAGES/bottles.po']),
                ('bin/bottles/locale/fr_FR/LC_MESSAGES',['bottles/locale/fr_FR/LC_MESSAGES/bottles.mo']),
                ('bin/bottles/locale/fr_FR/LC_MESSAGES',['bottles/locale/fr_FR/LC_MESSAGES/bottles.po']),
                ('bin/bottles/locale/de_DE/LC_MESSAGES',['bottles/locale/de_DE/LC_MESSAGES/bottles.mo']),
                ('bin/bottles/locale/de_DE/LC_MESSAGES',['bottles/locale/de_DE/LC_MESSAGES/bottles.po']),]
